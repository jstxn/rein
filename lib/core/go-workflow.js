import { getInterviewNext } from "./interview-orchestration.js";
...
function advanceGoFlow(options = {}) {
  ...
  const changedFiles = options.changedFiles ? parseJsonFlag(options.changedFiles, "changed-files") : [];
...
function getGoStatus(slug, options = {}) {
  return buildView(loadGoState(slug, options));
}
