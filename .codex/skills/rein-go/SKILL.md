...
1. Interview
   ...
   - While interview is still active, use the normal `rein interview ...` runtime commands.
   - After crystallization, call `rein go resume --slug <slug> --json` to let the go runtime advance into planning.
