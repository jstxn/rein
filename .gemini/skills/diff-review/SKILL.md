...
name: diff-review
description: >-
  Use before committing. Self-reviews the current diff for unrelated changes,
  debug leftovers, test weakening, and scope drift.
---
...
- verify has already been run and covers diff review (avoid duplication)
