...
name: inspect
description: >-
  Understand a codebase and maintain .rein/codebase/ as a navigable map with
...
`inspect` is a documentation-first reconnaissance skill. Its job is to understand a codebase carefully and maintain a durable map of that understanding under `.rein/codebase/`.
